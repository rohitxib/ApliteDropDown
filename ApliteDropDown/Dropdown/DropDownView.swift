...
//  ApliteDropDown
//
//  Created by Aplite_Mac on 10/10/22.
//
...
public class DropDownView: UIView {
    ...
    public  var cellTextCgColor = CGColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1)
  public  var TitleTextCgColor = CGColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1){
      didSet {
          lblMain.textColor = UIColor(cgColor: TitleTextCgColor)
}
}
    
    
    public var  titleText = "please select"{
        didSet {
    lblMain.text = titleText
}
}
...
extension DropDownView : UITableViewDataSource,UITableViewDelegate{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblTitle.textColor = UIColor(cgColor: cellTextCgColor)
        return cell
